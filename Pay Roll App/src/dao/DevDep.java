...
public class DevDep  {
	...
	public static void devDepPay(PayPojo p) throws ClassNotFoundException, SQLException{
	...
	public static void DevCalci(PayPojo p) throws ClassNotFoundException, SQLException {
		while(payRollDb.readLogin(p)) {
